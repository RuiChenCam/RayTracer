...
%8. Angle change for FEKO (currently supports manual or Royce data) (done)
...
%       patterns and FEKO. Do remember to include 'feko' in the filename of
%       FEKO generated patterns. Or the program will read it as StarLab
%       patterns
%
% 
% 
...
mesh_.xNodeNum = 51;   % Keep the x and y mesh size the same, increase the size for better resolution and especially if you're increasing the frequency
mesh_.yNodeNum = 51;
mesh_.zNodeNum = 1;
